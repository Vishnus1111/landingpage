...
const steps = [
  { icon: MessageSquare, title: 'Understand', description: 'Deep dive into your goals, audience, and requirements to craft the perfect strategy.' },
  { icon: Palette, title: 'Design', description: 'Create stunning visuals and intuitive interfaces that reflect your brand identity.' },
  { icon: Code, title: 'Develop', description: 'Build robust, scalable solutions using modern technologies and best practices.' },
  { icon: HeartHandshake, title: 'Support', description: 'Ongoing maintenance, updates, and support to ensure your success long-term.' },
];
              ...
              <motion.div key={step.title} initial={{ opacity: 0, y: 28 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.12 }}>
                <div className="group flex flex-col items-center text-center">
                  <div className="relative mb-6">
                    <div className="w-14 h-14 rounded-2xl bg-[#eef1ff] group-hover:bg-[#000066] flex items-center justify-center transition-colors duration-300 shadow-sm">
                      <step.icon className="w-7 h-7 text-[#000066] group-hover:text-white transition-colors duration-300" />
                    </div>
